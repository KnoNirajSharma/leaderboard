...
import com.knoldus.leader_board.WriteMonthlyReputation
...
class MonthlyReputationActor(monthlyReputation: MonthlyReputation,
  ...
  override def receive: Receive = {
    case WriteMonthlyReputation => val monthlyReputations = monthlyReputation.getKnolderMonthlyReputation
