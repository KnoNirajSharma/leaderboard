    ...
    score match {
      case Some(value) => logger.info("getting default points of contribution and the contribution multiplier")
        ContributionPointsWithMultiplier(PointsAndMultiplier(scorePerBlog, value.blogScoreMultiplier),
          ...
          PointsAndMultiplier(scorePerConference, value.conferenceScoreMultiplier),
          PointsAndMultiplier(scorePerResearchPaper, value.researchPaperScoreMultiplier), PointsAndMultiplier(scorePerMeetup, value.meetupScoreMultiplier),
