...
class QuarterlyReputationImplSpec extends AnyFlatSpec with MockitoSugar {
  ...
  "get quarterly reputation" should "return knolder reputation of each knolder along with their knolder id" in {
    ...
    val firstMonthBlogCount = List(GetContributionCount(1, "Mukesh Gupta", 3, 2,1,1,1,1,1,1), GetContributionCount(2, "anjali", 2, 1,1,1,1,1,1,1))

    when(mockReadContribution.fetchKnoldersWithQuarterFirstMonthContributions)
      .thenReturn(List(GetContributionCount(1, "Mukesh Gupta", 3, 2,1,1,1,1,1,1), GetContributionCount(2, "anjali", 2, 1,1,1,1,1,1,1)))
    ...
    val secondMonthBlogCount = List(GetContributionCount(1, "Mukesh Gupta", 4, 1,1,1,1,1,1,1), GetContributionCount(2, "anjali", 2, 1,1,1,1,1,1,1))

    when(mockReadContribution.fetchKnoldersWithQuarterSecondMonthContributions)
      .thenReturn(List(GetContributionCount(1, "Mukesh Gupta", 4, 1,1,1,1,1,1,1), GetContributionCount(2, "anjali", 2, 1,1,1,1,1,1,1)))
    ...
    val thirdMonthBlogCount = List(GetContributionCount(1, "Mukesh Gupta", 4, 1,1,1,1,1,1,1), GetContributionCount(2, "anjali", 3, 1,1,1,1,1,1,1))

    when(mockReadContribution.fetchKnoldersWithQuarterThirdMonthContributions)
      .thenReturn(List(GetContributionCount(1, "Mukesh Gupta", 4, 1,1,1,1,1,1,1), GetContributionCount(2, "anjali", 3, 1,1,1,1,1,1,1)))
