...
@DoNotDiscover
class StoreBooksContributionImplSpec extends DBSpec with BeforeAndAfterEach {
  implicit val connection: Connection = DatabaseConnection.connection(ConfigFactory.load())
  val storeData: StoreBooksContribution = new StoreBooksContributionImpl(ConfigFactory.load())
  ...
  "StoreBooksContributionImpl" should {

    "return number of rows affected when insertion in books contribution table" in {
...
""".stripMargin
      ...
      val otherContribution = List(
        ...
        OtherContributionDetails("2", "abhishek.baranwal@knoldus.com", "Abhishek", Option(Timestamp.valueOf("1970-01-19 15:11:46.0")), "Delta Lake", "Books"))

      val result = storeData.insertBooksContributionDetails(otherContribution)
