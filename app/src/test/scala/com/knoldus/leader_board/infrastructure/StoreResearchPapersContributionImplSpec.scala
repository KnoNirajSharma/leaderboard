...
@DoNotDiscover
class StoreResearchPapersContributionImplSpec extends DBSpec with BeforeAndAfterEach {
  implicit val connection: Connection = DatabaseConnection.connection(ConfigFactory.load())
  val storeData: StoreResearchPapersContribution = new StoreResearchPapersContributionImpl(ConfigFactory.load())
  ...
  "StoreResearchPapersContributionDetailsImpl" should {

    "return number of rows affected when insertion in research paper contribution contribution table" in {
...
""".stripMargin
      ...
      val otherContribution = List(
        ...
        OtherContributionDetails("2", "abhishek.baranwal@knoldus.com", "Abhishek", Option(Timestamp.valueOf("1970-01-19 15:11:46.0")), "Delta Lake", "Research Paper"))

      val result = storeData.insertResearchPaperContributionDetails(otherContribution)
