...
@DoNotDiscover
class StoreKnolxImplSpec extends DBSpec with BeforeAndAfterEach {
  implicit val connection: Connection = DatabaseConnection.connection(ConfigFactory.load())
  val storeData: StoreKnolx = new StoreKnolxImpl(ConfigFactory.load())
  ...
  "Store Knolx" should {
    ...
    "return number of rows affected when insertion in knolx table" in {
...
""".stripMargin
      ...
      val result = storeData.insertKnolx(knolx)
